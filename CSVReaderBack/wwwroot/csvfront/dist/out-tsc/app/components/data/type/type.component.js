...
var TypeSelectComponent = /** @class */ (function () {
    function TypeSelectComponent(http) {
        this.http = http;
        this.typeModel = [];
    }
    TypeSelectComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.getData().subscribe(function (data) { return _this.typeModel = data["item3"]; });
    };
